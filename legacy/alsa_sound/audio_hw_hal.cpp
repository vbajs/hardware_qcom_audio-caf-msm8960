...
static uint32_t audio_device_conv_table[][HAL_API_REV_NUM] =
{
    ...
    { AudioSystem::DEVICE_OUT_ALL, AUDIO_DEVICE_OUT_PROXY },
#endif
#ifdef QCOM_FM_ENABLED
...
#ifdef QCOM_USBAUDIO_ENABLED
    { AudioSystem::DEVICE_OUT_ANLG_DOCK_HEADSET, AUDIO_DEVICE_IN_USB_DEVICE },
#endif
#ifdef QCOM_PROXY_DEVICE_ENABLED
    { AudioSystem::DEVICE_IN_ALL, AUDIO_DEVICE_IN_PROXY },
#endif
#ifdef QCOM_FM_ENABLED
